		...
		<div id="main">
			<div class="container-fluid">
				<div class="page-header">
					...
					<a style="position:absolute;right:180px;top:20px;" href="<?php echo $this->webroot;?>home/fin_guideline/" rel="tooltip"  title="GUIDELINES FOR ADVANCE & EXPENSES MANAGEMENT" class="iframeBox click_hide" val="75_85"><button class="btn-orange btn  btn-xs dropdown-toggle">
<span class="icon-info-sign icon-on-right"></span> Advance Expenses Guidelines
</button>
</a>	
					</div-->
