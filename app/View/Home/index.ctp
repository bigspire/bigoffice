							...
							<h4>
								Dashboard
										...
										<li  class="dashList">
												...
												<li class="dashList">
															<a data-toggle="tab" class="listlink ajaxTab" val="it" rel="tabbed_call-it"  id="ita" href="#it-tab">IT
															<?php if($it_count > 0):?>
...
<?php endif; ?>
								...
								<iframe src="/bigoffice/it/fr_it_home.php" width="900px" frameborder="0" scrolling="no" height="400px"></iframe>
								</div>
...
<div id="footer">
	<div class="wrapper">
    	<span>&copy; Copyright <?php echo date('Y');?>. BigSpire Software. All rights reserved. Powered by <a href="http://bigspire.com" target="_blank" title="BigSpire Software">BigSpire</a>
