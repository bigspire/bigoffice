		...
		<div class="container-fluid">
			...
			<li class="dropdown" >
				...
				<?php endif; ?>
					...
					<li class="dropdown <?php  echo $hrattwaive_menu;?> <?php  echo $hruploadatt_menu;?> <?php echo $hrdeactivatesat_menu;?> <?php echo $hremployee_menu;?> <?php echo $hrattendance_menu;?> <?php echo $hrattchange_menu; ?>  
					...
					<ul class="dropdown-menu">
					<?php if($att_change_menu == '1' &&  $this->Session->read('USER.Login.att_type') != 'N'):?>
					...
					<?php if($approve_waiveoff_change_menu == '1'):?>
					<li><a href="<?php echo $this->webroot;?>hrattwaive/">Approve Waive-Off Request
					<?php if($WAIVE_REQ_COUNT > 0): ?>
							<span class="label label-lightred bubble"><?php echo $WAIVE_REQ_COUNT; ?></span>
							<?php endif; ?>
							</a></li>
					<?php endif; ?>
				...
				<?php if($company_menu == '1' || $branch_menu == '1' || $business_unit_menu == '1' || $department_menu == '1' || $designation_menu == '1' ):?>	
