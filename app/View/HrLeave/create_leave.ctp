									...
									<div class="span8">
										...
										<div class="control-group halfL dn">
											...
											<div class="controls" >
												...
												<?php echo $this->Form->input('session', array('div'=> false,'type' => 'select', 'label' => false, 'class' => 'input-large session2', 'empty' => 'Select', 'required' => false, 'placeholder' => '', 'style' => "clear:left;margin-left:20px;", 'options' => array('M' => 'Morning', 'A' => 'Afternoon'), 'id' => 'session', 'error' =>  array('attributes' => array('style' => "margin-left:38px", 'wrap' => 'div', 'class' => 'error')))); ?> 
