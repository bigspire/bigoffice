							...
							<div class="box-content"  style="color:#555;">
									...
									<div class="row-fluid row<?php echo $key;?>" style="margin-left:10px">
										...
										<div class="span4">
											...
											<?php endif; ?>
												<div class="controls controls-row">
													<?php echo $this->Form->input('description_o'.$key, array('div'=> false,'type' => 'textarea','rows' => '1', 'value' => $list['FinExpList']['description'], 'label' => false, 'id' => 'desc_o4', 'class' => 'input-block-level required autosize',  'required' => false, 'placeholder' => '', 'error' =>  array('attributes' => array('wrap' => 'div', 'class' => 'error')))); ?> 
												</div>
											</div>
										</div>
										<div class="span1">
											...
											<?php endif; ?>
												<div class="controls controls-row">
												<?php echo $this->Form->input('amount_o'.$key, array('div'=> false,'type' => 'text', 'label' => false,'id' => 'amt_o'.$key, 'value' => $list['FinExpList']['amount'], 'maxlength' => 6,'class' => 'amtExp input-block-level required amtVal',  'required' => false, 'placeholder' => '', 'error' =>  array('attributes' => array('wrap' => 'div', 'class' => 'error')))); ?> 
												</div>
											</div>
										</div>
										...
										<div class="span2">
											...
											<?php endif; ?>
												<div class="controls controls-row">
													<?php echo $this->Form->input('bill_refno_o'.$key, array('div'=> false,'type' => 'text', 'maxlength' => 10, 'value' => $list['FinExpList']['bill_refno'],'label' => false,'id' => 'billref_o'.$key, 'class' => 'input-block-level',  'required' => false, 'placeholder' => 'Compulsory for > ₹50', 'error' =>  array('attributes' => array('wrap' => 'div', 'class' => 'error')))); ?> 
												</div>
											</div>
										</div>
										<div class="">
									...
									<div class="row-fluid" style="margin-left:10px">
										...
										<div class="span1">
											<div class="control-group">
												...
												<div class="controls controls-row">
												<?php echo $this->Form->input('amount', array('div'=> false,'type' => 'text', 'label' => false, 'name' => "data[FinExpense][amount_#index#]", 'class' => 'amtExp input-block-level required amtVal', 'maxlength' => 6,'value' => '', 'id' => 'amt_#index#',  'required' => false, 'placeholder' => '', 'error' =>  array('attributes' => array('wrap' => 'div', 'class' => 'error')))); ?> 
												</div>
											</div>
										</div>
