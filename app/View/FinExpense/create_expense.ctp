<?php echo $this->element('fin_menu'); ?>
									...
									<div class="row-fluid row1" style="margin-left:10px">
										...
										<div class="span4">
											<div class="control-group">
												...
												<div class="controls controls-row">
													<?php echo $this->Form->input('description_o1', array('div'=> false,'type' => 'textarea', 'rows' => '1', 'label' => false, 'id' => 'desc_o1','class' => 'autosize input-block-level required',  'required' => false, 'placeholder' => '', 'error' =>  array('attributes' => array('wrap' => 'div', 'class' => 'error')))); ?> 
												</div>
											</div>
										</div>
										<div class="span1">
											<div class="control-group">
												...
												<div class="controls controls-row">
												<?php echo $this->Form->input('amount_o1', array('div'=> false,'type' => 'text','maxlength' => 6, 'label' => false, 'id' => 'amt_o1', 'class' => 'amtExp input-block-level required amtVal',  'required' => false, 'placeholder' => '', 'error' =>  array('attributes' => array('wrap' => 'div', 'class' => 'error')))); ?> 
												</div>
											</div>
										</div>
										...
										<div class="span2">
											<div class="control-group">
												...
												<div class="controls controls-row">
													<?php echo $this->Form->input('bill_refno_o1', array('div'=> false,'type' => 'text', 'maxlength' => 15,  'id' => 'billref_o1', 'label' => false, 'class' => 'input-block-level',  'required' => false, 'placeholder' => 'Compulsory for > ₹50', 'error' =>  array('attributes' => array('wrap' => 'div', 'class' => 'error')))); ?> 
												</div>
											</div>
										</div>
									</div>
									...
									<div class="row-fluid row02" style="margin-left:10px">
										...
										<div class="span4">
											<div class="control-group">
												...
												<div class="controls controls-row">
													<?php echo $this->Form->input('description_o2', array('div'=> false,'type' => 'textarea', 'label' => false, 'rows' => '1', 'id' => 'desc_o2', 'class' => 'autosize input-block-level required',  'required' => false, 'placeholder' => '', 'error' =>  array('attributes' => array('wrap' => 'div', 'class' => 'error')))); ?> 
												</div>
											</div>
										</div>
										<div class="span1">
											<div class="control-group">
												...
												<div class="controls controls-row">
												<?php echo $this->Form->input('amount_o2', array('div'=> false,'type' => 'text','maxlength' => 6, 'label' => false, 'id' => 'amt_o2', 'class' => 'amtExp input-block-level required amtVal',  'required' => false, 'placeholder' => '', 'error' =>  array('attributes' => array('wrap' => 'div', 'class' => 'error')))); ?> 
												</div>
											</div>
										</div>
										...
										<div class="span2">
											<div class="control-group">
												...
												<div class="controls controls-row">
													<?php echo $this->Form->input('bill_refno_o2', array('div'=> false,'type' => 'text', 'label' => false, 'id' => 'billref_o2', 'class' => 'input-block-level', 'maxlength' => 15,  'required' => false, 'placeholder' => 'Compulsory for > ₹50', 'error' =>  array('attributes' => array('wrap' => 'div', 'class' => 'error')))); ?> 
												</div>
											</div>
										</div>
										<div class="">
									...
									<div class="row-fluid row03" style="margin-left:10px">
										...
										<div class="span4">
											<div class="control-group">
												...
												<div class="controls controls-row">
													<?php echo $this->Form->input('description_o3', array('div'=> false,'type' => 'textarea', 'rows' => '1', 'id' => 'desc_o3', 'label' => false, 'class' => 'autosize input-block-level required',  'required' => false, 'placeholder' => '', 'error' =>  array('attributes' => array('wrap' => 'div', 'class' => 'error')))); ?> 
												</div>
											</div>
										</div>
										<div class="span1">
											<div class="control-group">
												...
												<div class="controls controls-row">
												<?php echo $this->Form->input('amount_o3', array('div'=> false,'type' => 'text', 'maxlength' => 6,'label' => false, 'id' => 'amt_o3', 'class' => 'amtExp input-block-level required amtVal',  'required' => false, 'placeholder' => '', 'error' =>  array('attributes' => array('wrap' => 'div', 'class' => 'error')))); ?> 
												</div>
											</div>
										</div>
										...
										<div class="span2">
											<div class="control-group">
												...
												<div class="controls controls-row">
													<?php echo $this->Form->input('bill_refno_o3', array('div'=> false,'type' => 'text', 'id' => 'billref_o3', 'label' => false, 'class' => 'input-block-level', 'maxlength' => 15,  'required' => false, 'placeholder' => 'Compulsory for > ₹50', 'error' =>  array('attributes' => array('wrap' => 'div', 'class' => 'error')))); ?> 
												</div>
											</div>
										</div>
									...
									<div class="row-fluid row04" style="margin-left:10px">
										...
										<div class="span4">
											<div class="control-group">
												...
												<div class="controls controls-row">
													<?php echo $this->Form->input('description_o4', array('div'=> false, 'rows' => '1', 'type' => 'textarea', 'label' => false, 'id' => 'desc_o4', 'class' => 'autosize input-block-level required',  'required' => false, 'placeholder' => '', 'error' =>  array('attributes' => array('wrap' => 'div', 'class' => 'error')))); ?> 
												</div>
											</div>
										</div>
										<div class="span1">
											<div class="control-group">
												...
												<div class="controls controls-row">
												<?php echo $this->Form->input('amount_o4', array('div'=> false,'type' => 'text', 'maxlength' => 6,'label' => false,'id' => 'amt_o4',  'class' => 'amtExp input-block-level required amtVal',  'required' => false, 'placeholder' => '', 'error' =>  array('attributes' => array('wrap' => 'div', 'class' => 'error')))); ?> 
												</div>
											</div>
										</div>
										...
										<div class="span2">
											<div class="control-group">
												...
												<div class="controls controls-row">
													<?php echo $this->Form->input('bill_refno_o4', array('div'=> false,'type' => 'text', 'label' => false,'id' => 'billref_o4', 'class' => 'input-block-level', 'maxlength' => 15,  'required' => false, 'placeholder' => 'Compulsory for > ₹50', 'error' =>  array('attributes' => array('wrap' => 'div', 'class' => 'error')))); ?> 
												</div>
											</div>
										</div>
										<div class="">
									...
									<div class="row-fluid" style="margin-left:10px">
										...
										<div class="span4">
											<div class="control-group">
												...
												<div class="controls controls-row">
													<?php echo $this->Form->input('description', array('div'=> false,'type' => 'textarea', 'rows' => '1', 'label' => false, 'id' => 'desc_#index#','name' => "data[FinExpense][description_#index#]", 'class' => 'input-block-level required autosize',  'required' => false, 'placeholder' => '', 'error' =>  array('attributes' => array('wrap' => 'div', 'class' => 'error')))); ?> 
												</div>
											</div>
										</div>
										<div class="span1">
											<div class="control-group">
												...
												<div class="controls controls-row">
												<?php echo $this->Form->input('amount', array('div'=> false,'type' => 'text', 'label' => false, 'name' => "data[FinExpense][amount_#index#]", 'class' => 'amtExp input-block-level amtVal required', 'maxlength' => 6,'id' => 'amt_#index#',  'required' => false, 'placeholder' => '', 'error' =>  array('attributes' => array('wrap' => 'div', 'class' => 'error')))); ?> 
												</div>
											</div>
										</div>
										...
										<div class="span2">
											<div class="control-group">
												...
												<div class="controls controls-row">
													<?php echo $this->Form->input('bill_refno', array('div'=> false,'type' => 'text', 'label' => false, 'name' => "data[FinExpense][bill_refno_#index#]", 'id' => 'billref_#index#', 'maxlength' => 15, 'class' => 'input-block-level',  'required required' => false, 'placeholder' => 'Compulsory for > ₹50', 'error' =>  array('attributes' => array('wrap' => 'div', 'class' => 'error')))); ?> 
												</div>
											</div>
										</div>
	...
	<div class="controls controls-row">
									...
									<div  style="margin-left:10px;">
										...
										<input type="hidden" value="<?php echo date('d/m/Y', strtotime(date('Y-m-d'). '-10 days'));?>" id="start_date">
