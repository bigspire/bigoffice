...
<div class="span6">		
	...
	<div class="control-group">
							...
							<div class="span12">
										...
										<a href="add_software_details.php"><button type="button" class="btn"><i class="icon-arrow-left"></i> Previous</button></a>
												<a href="add_software_pricing_details.html"><input type="submit" name="next" value="Next" class="btn btn-primary"></a>
				
											
											<a href="list_software.html"><button type="button" class="btn regCancel" onclick="return cancelfunction()">Cancel</button></a>
