	...
	{html_options name=type class="input-xlarge" placeholder="" style="clear:left" id="type" options=$br_type selected=$type}	
							...
							<div class="span12">
										<div class="form-actions">
											<a href="list_brand.php"><input onclick="return validate_brand()" type="submit" name="submit" value="Submit" class="btn btn-primary"></a>
				                        
											
											<a href="list_brand.php"><button type="button" class="btn regCancel" onclick="return cancelfunction()">Cancel</button></a>
