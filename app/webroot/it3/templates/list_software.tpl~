	...
	<div class="container-fluid" id="content">
		<div id="main">
			<div class="container-fluid">
             ...
             <a href="list_software.php?action=export&keyword={$smarty.post.keyword}&sw_type={$smarty.post.sw_type}&sw_status={$smarty.post.sw_status}&f_date={$smarty.post.f_date}&t_date={$smarty.post.t_date}"><button type="button" class="btn btn-primary" style="float:right;margin-right:20px;"><i class="icon-reply"></i> Export</button></a>
								...
								<table class="table table-hover table-nomargin table-bordered usertable dataTable">
		                         ...
		                         <td>{$item.validity_year} {if $item.validity_date}({$item.validity_date}){/if}</td> 
