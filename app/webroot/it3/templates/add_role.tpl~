			...
			<div class="container-fluid">
				...
				<div class="control-group">
						<label  for="textfield" class="control-label"> Permissions <span class="red_star"> *</span> </label>
							<div class="controls field" >					
{html_options name="permission[]" multiple="multiple" size="10" separator="  " class="multi_select" id="RolePermission[]" placeholder="" style="clear:left" options=$permissions selected=$permission_ar}				
<div class="errorMsg error">{$permissionErr} </div>
</div>
				</div>
				<div class="control-group">
