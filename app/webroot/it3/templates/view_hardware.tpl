...
<div class="span6">	
										...
										<label for="textfield" class="control-label">Subscription Validity   </label>
											<div class="controls">
											 	{$item.validity_year} {if $item.validity_date}( {$item.validity_date} ){/if}
											</div>
									</div>
						...
						<div class="box">
                         ...
                         <div class="control-group">
		                         <label for="password" class="control-label">Attach Warranty </label>
									    <div class="controls">
											<a href = "view_hardware.php?id={$smarty.get.id}&action=download&file={$item.warranty}">{$item.warranty}</a>
										</div>
										</div>
	...
	<div class="control-group">
											...
											<div class="controls">
                      				<a href = "view_hardware.php?id={$smarty.get.id}&action=download&file={$item.bill}">{$item.bill}</a>
											</div>
						</div>
