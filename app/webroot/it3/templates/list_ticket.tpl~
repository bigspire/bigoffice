	...
	<div class="container-fluid" id="content">
		<div id="main">
			<div class="container-fluid">
             ...
             <a href="list_ticket.php?action=export&keyword={$smarty.post.keyword}&emp_name={$smarty.post.emp_name}&t_status={$smarty.post.t_status}&f_date={$smarty.post.f_date}&t_date={$smarty.post.t_date}"><button type="button" class="btn btn-primary" style="float:right;margin-right:20px;"><i class="icon-reply"></i> Export</button></a>
			   </div>			
