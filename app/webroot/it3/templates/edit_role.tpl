...
{html_options name="app_modules_id[]" multiple="multiple" size="10" separator="  " class="multi_select" id="RolePermission[]" placeholder="" style="clear:left"  options=$permissions selected=$app_modules_id}				
<div class="errorMsg error">{$app_modules_idErr} </div>										</div>
										</div>
