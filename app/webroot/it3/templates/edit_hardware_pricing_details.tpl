			...
			<div class="container-fluid">
				...
				<div class="breadcrumbs">
					<ul>
						...
						<li>
							<a href="edit_hardware_pricing_details.php?id={$getid}">Edit Hardware</a>
						</li>
					</ul>
					...
					<div class="span12">
								...
								<form action="edit_hardware_pricing_details.php?id={$getid}" method="POST" class="form-horizontal form-column form-bordered form-wizard ui-formwizard" enctype="multipart/form-data" id="formID" novalidate="novalidate">
									...
									<div class="span6">
										...
										<div class="control-group">
											...
											<div class="controls field">
												<input name="amount" class="input-xlarge" placeholder="" type="text" id="amount" value="{$smarty.session['h'].amount}"/> 	
{html_options name=currency_type class="input-small" placeholder="" style="clear:left" id="currency_type" options=$currency_types selected=$smarty.session['h'].currency_type}																								
											<div class="errorMsg error">{$amountErr}{$amountE}</div>
													
											<div class="errorMsg error">{$currency_typeErr}</div>
											</div>
										</div>
...
<div class="errorMsg error">{$paid_byErr}</div>
                         ...
                         <div class="control-group">
		                         <label for="password" class="control-label">Attach Warranty <span class="red_star"> </span> </label>
									    <div class="controls">
											<input type="file" name="attach_warranty"  class="upload" id="attach_warranty"/>
										<div class="error">{$waruploadErr} </div>
										</div>
										</div>
...
<div class="span6">		
	...
	<div class="control-group">
											<label for="password" class="control-label">Paid Date <span class="red_star"> *</span></label>
											<div class="controls field">
												<input name="paid_date" class="input-medium datepick" placeholder="" type="text" id="paid_date" value="{$smarty.session['h'].paid_date}"/>  dd/mm/yyyy 
											<div class="errorMsg error">{$paid_dateErr} </div>
											</div>
										</div>
