...
{html_options class="input-medium" placeholder="" style="clear:left"  options=$state selected=$smarty.session['h'].state}
	</select>
	<select name="district" id="district_id">
	<option value="">Select</option>
{html_options class="input-large" placeholder="" style="clear:left"  options=$district selected=$smarty.session['h'].district}
		</select>		
