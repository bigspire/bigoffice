			...
			<div class="container-fluid">
				...
				<div class="breadcrumbs">
					<ul>
						...
						<li>
							<a href="edit_hardware_vendor_details.php?id={$getid}">Edit Hardware</a>
						</li>
					</ul>
					...
					<div class="span12">
								...
								<form action="edit_hardware_vendor_details.php?id={$getid}" method="POST" class="form-horizontal form-column form-bordered form-wizard ui-formwizard" enctype="multipart/form-data" id="formID" novalidate="novalidate">
