		...
		<div id="main">
			<div class="container-fluid">
			   ...
			   {if $ALERT_MSG}
				...
				{/if}	<div class="row-fluid footer_div" >
					<div class="span12">
			...
			<div class="" id="DataTables_Table_8_filter"  style="padding:15px">
				...
				<a href="list_role.php?action=export&keyword={$smarty.post.keyword}"><button type="button" name="export" class="btn btn-primary" style="float:right;margin-right:20px;"><i class="icon-reply"></i> Export</button></a>					
			</div>			
