	                           ...
	                           <div class="control-group">
	                               ...
	                               <div class="control-group">
									...
									<div class="control-group">
											...
											<div class="controls">
											{if ($smarty.session['s'].validitydate == '')}
												{$smarty.session['s'].validityyear}
											{else}
											{$smarty.session['s'].validityyear} ( {$smarty.session['s'].validitydate} )
											{/if}	
											</div>
										</div>
						...
						<div class="box">
							...
							<div class="box-content nopadding">
										...
										<div class="control-group">
											...
											<div class="controls">
											 {$smarty.session['s'].amount} {$smarty.session['s'].currencytype}
													</div>
										</div>
                         ...
                         <div class="control-group">
		                         <label for="password" class="control-label">Attach Warranty </label>
									    <div class="controls">
 											{if !empty($smarty.session['s'].warfile_edit)}
									    	<a href = "edit_software_confirmation.php?id={$smarty.get.id}&action=download&file={$smarty.session['s'].warfile_edit}">{$smarty.session['s'].warfile_edit}</a> 
										{else}									    
									    	<a href = "edit_software_confirmation.php?id={$smarty.get.id}&action=download&file={$smarty.session['s'].warfile}">{$smarty.session['s'].warfile}</a> 
										{/if}	
										</div>
										</div>
	...
	<div class="control-group">
							...
							<div class="span12">
										<div class="form-actions">
											<a href="edit_software_vendor_details.php?id={$getid}"><input type="button" class="btn" name="previous" id="submit_previous" value="Previous"></a>
