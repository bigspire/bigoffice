   ...
   Date : 16-06-2016 *}
	...
	<div class="container-fluid" id="content">
		<div id="main">
           ...
           <a href="list_login.php"><button style="margin-bottom:9px;margin-left:4px;" type="button" class="btn btn-primary"><i class="icon-refresh"></i> Reset</button></a>
           <a href="add_login.php"><button type="button" class="btn btn-primary" style="float:right"><i class="icon-plus"></i> Add Login</button></a>
           <a href="list_login.php?action=export&keyword={$smarty.post.keyword}&emp_name={$smarty.post.emp_name}&l_status={$smarty.post.l_status}"><button type="button" class="btn btn-primary" style="float:right;margin-right:20px;"><i class="icon-reply"></i> Export</button></a>				
           </div>			
								<table class="table table-hover table-nomargin table-bordered usertable dataTable">
									<thead>	
										...
										<th width="60">
											<a href="list_login.php?field=server&order={$order}&page={$smarty.get.page}&keyword={$keyword}&l_status={$l_status}" class="{$sort_field_server}">Server</a></th>
										<th width="60">
