...
{if !$ALERT_MSG and !$ALERT_MSG1}
			<form action="fr_asset_change_user.php?type={$get_type}" id="formID" class="" method="post" accept-charset="utf-8">
			<div style="display:none;"><input type="hidden" name="_method" value="POST"/></div>			
									...
									<div class="form-group" style="text-align:left">
										...
										<div class="col-sm-3">
											<textarea id="field0" rows="8" cols="48" name="message" >{$message}</textarea><br>
											<div class="error error0">{$messageErr}</div>
