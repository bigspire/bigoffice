	...
	<div class="container-fluid" id="content">
		<div id="main">
			<div class="container-fluid">
             ...
             <a href="list_brand.php?action=export&keyword={$smarty.post.keyword}&b_type={$smarty.post.b_type}&b_status={$smarty.post.b_status}"><button type="button" name="export" class="btn btn-primary" style="float:right;margin-right:20px;"><i class="icon-reply"></i> Export</button></a>				
            </div>			
								 ...
								 <tr>
								   ...
								   <td style="text-align:center"><span class='label label-{$item.status_cls}'><a href='#' rel='tooltip' data-original-title = {$item.status}>{$item.status}</a></span></td>
									<td class='hidden-480'>
										...
										<a href="delete_brand.php?id={$item.id}&page={$smarty.get.page}" name="21" onclick="return deletefunction()"	class="btn delRec" rel="tooltip" title="Delete"><i class="icon-remove"></i></a>
									</td>
								</tr>
								 {/if}
							{/foreach}	
