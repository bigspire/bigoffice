						...
						<div class="box">
                         ...
                         <div class="control-group">
		                         <label for="password" class="control-label">Attach Warranty </label>
									    <div class="controls">
									    	<a href = "add_software_confirmation.php?id={$smarty.get.id}&action=download&file={$smarty.session['s'].warfile}">{$smarty.session['s'].warfile}</a> 
										</div>
										</div>
   ...
   <div class="control-group">
	...
	<div class="control-group">
							...
							<div class="span12">
										...
										<a href="add_software_vendor_details.php"><input type="button" id="submit_previous" class="btn" name="previous" value="Previous"></a>
