				...
				<div class="row-fluid  footer_div">
					...
					<form action="view_change_asset_info.php" id="formID" class="form-horizontal form-column form-bordered" enctype="multipart/form-data" method="post" accept-charset="utf-8">											
						...
						<div class="span6">
							...
							<div class="control-group">
								 <label for="password" class="control-label">Created Date<span class="red_star"></span></label>
                  ...
                  <div class="span6">		
						...
						<div class="span12">
							<div class="form-actions">
								<a href="list_change_asset_info.php"><input type="button" value="Back" class="btn btn-primary"></a>
							</div>
						</div>
				  </div>
				</div>
