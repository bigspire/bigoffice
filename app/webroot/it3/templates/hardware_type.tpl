   ...
   Date : 15-06-2016 *}
	...
	<div class="container-fluid" id="content">
		<div id="main">
            ...
            <a href="hardware_type.php?action=export&keyword={$smarty.post.keyword}&hw_status={$smarty.post.hw_status}"><button type="button" class="btn btn-primary" style="float:right;margin-right:20px;"><i class="icon-reply"></i> Export</button></a>		
            </div>			
