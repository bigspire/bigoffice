		...
		<div id="main">
			<div class="container-fluid">
				...
				<div class="breadcrumbs">
				 ...
				 <div id="flashMessage" class="alert alert-success"><button type="button" class="close" data-dismiss="alert">×</button></div>					
					...
					<div class="span12">
						...
						<a href="dashboard.php" ><button type="button" class="btn regCancel" >Back</button></a>
							</div>
						 </form>						
						 </div>
					</div>
