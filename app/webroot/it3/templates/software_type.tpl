   ...
   Date : 15-06-2016 *}
	...
	<div class="container-fluid" id="content">
		<div id="main">
            ...
            <a href="software_type.php?action=export&keyword={$smarty.post.keyword}&sw_status={$smarty.post.sw_status}"><button type="button" class="btn btn-primary" style="float:right;margin-right:20px;"><i class="icon-reply"></i> Export</button></a>		
            </div>			
