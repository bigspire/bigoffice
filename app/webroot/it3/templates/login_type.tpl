	...
	<div class="container-fluid" id="content">
		<div id="main">
			<div class="container-fluid">
             ...
             <a href="login_type.php?action=export&keyword={$smarty.post.keyword}&l_status={$smarty.post.l_status}"><button type="button" class="btn btn-primary" style="float:right;margin-right:20px;"><i class="icon-reply"></i> Export</button></a>
				</div>			
