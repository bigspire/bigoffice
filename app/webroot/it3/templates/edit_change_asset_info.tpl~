...
<div class="control-group">
	...
	<div class="control-group">
											...
											<div class="controls">
	{html_options name=status class="input-xlarge" placeholder="" style="clear:left" id="status" options=$change_asset_status selected=$status}	
<div class="error">{$statusErr} </div>
										...
										<div class="form-actions">
											<a href="list_change_asset_info.php"><input type="submit" name="next" value="Submit" class="btn btn-primary"></a>
				                        
											
											<a href="list_change_asset_info.php"><button type="button" class="btn regCancel">Cancel</button></a>
