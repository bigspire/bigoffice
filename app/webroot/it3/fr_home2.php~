...
$query = "call it_count_change_emp('1')";
try{
...
// count ticket emp
$query = "CALL it_count_ticket_emp('1')";
try{
	if(!$result = $mysql->execute_query($query)){
...
$query = "CALL it_list_change_request_emp('1','0','0','','')";
try{
	if(!$result = $mysql->execute_query($query)){
...
$query = "CALL it_list_ticket_emp('1','0','0','','')";
try{
	if(!$result = $mysql->execute_query($query)){
...
$query = "CALL it_list_change_request_emp('1','0','$limit','".$field."','".$order."')";
...
$query = "CALL it_list_ticket_emp('1','0','$limit','".$field."','".$order."')";
...
// fetch all records for list_assign_emp for software
$query = "CALL it_list_assign_emp('1','S')";
...
$query = "CALL it_list_assign_emp('1','H')";
