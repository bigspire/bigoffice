<?php
/* Smarty version 3.1.29, created on 2016-09-07 12:41:04
  from "F:\xampp\htdocs\ceo_apps_it\app\webroot\it\templates\list_role.tpl" */

if ($_smarty_tpl->smarty->ext->_validateCompiled->decodeProperties($_smarty_tpl, array (
  'has_nocache_code' => false,
  'version' => '3.1.29',
  'unifunc' => 'content_57cfbd882707e0_43807775',
  'file_dependency' => 
  array (
    'a67891924ebb176377305b7aa2ef19171e3fd0cb' => 
    array (
      0 => 'F:\\xampp\\htdocs\\ceo_apps_it\\app\\webroot\\it\\templates\\list_role.tpl',
      1 => 1472120842,
      2 => 'file',
    ),
  ),
...
function content_57cfbd882707e0_43807775 ($_smarty_tpl) {
?>
		...
		<div id="main">
			<div class="container-fluid">
			   ...
			   <?php if ($_smarty_tpl->tpl_vars['ALERT_MSG']->value) {?>
				...
				<?php }?>	<div class="row-fluid footer_div" >
					<div class="span12">
...
" class="input-large" id="keyword" autocomplete="off" placeholder="Search here..." type="text"/> 
				...
				<a href="list_role.php"><button style="margin-bottom:9px;margin-left:4px;" type="button" class="btn btn-primary"><i class="icon-refresh"></i> Reset</button></a>
				<a href="add_role.php"><button type="button" class="btn btn-primary" style="float:right"><i class="icon-plus"></i> Add Role</button></a>
				<a href="list_role.php?action=export&keyword=<?php echo $_POST['keyword'];?>
"><button type="button" name="export" class="btn btn-primary" style="float:right;margin-right:20px;"><i class="icon-reply"></i> Export</button></a>					
			</div>			
