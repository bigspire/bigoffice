<?php
/* Smarty version 3.1.29, created on 2016-09-07 12:40:54
  from "F:\xampp\htdocs\ceo_apps_it\app\webroot\it\templates\include\menu.tpl" */

if ($_smarty_tpl->smarty->ext->_validateCompiled->decodeProperties($_smarty_tpl, array (
  'has_nocache_code' => false,
  'version' => '3.1.29',
  'unifunc' => 'content_57cfbd7e44bd09_52071180',
  'file_dependency' => 
  array (
    'aafee711362f8e35a1625f5d737e2fe791aba4ac' => 
    array (
      0 => 'F:\\xampp\\htdocs\\ceo_apps_it\\app\\webroot\\it\\templates\\include\\menu.tpl',
      1 => 1473232251,
      2 => 'file',
    ),
  ),
...
function content_57cfbd7e44bd09_52071180 ($_smarty_tpl) {
?>
...
echo $_smarty_tpl->tpl_vars['ticket_count']->value;
 ...
 dropdown language-select">
						...
						<ul class="dropdown-menu pull-right">
							<li>
								<a href="/ceo_apps_it/home/"><i class="icon-home"></i><span>Home</span></a>
							</li>
							<li>
								<a href="/ceo_apps_it/hrhome/" class=""><i class="icon-user"></i><span>HRIS
								<span class="switchLoad-sub"></span></span>
								<span class="label label-lightred bubble switchTour switchPre" id="hr_count"></span></a>
							</li>
							<li>
								<a href="/ceo_apps_it/finhome/" class=""><i class="icon-money"></i><span>Finance
								<span class="switchLoad-sub"></span></span>
							<span class="label label-lightred bubble switchFin switchPre"  id="fin_count"></span>
							</a>
							</li>
							<li>
								<a href="/ceo_apps_it/tskhome/" class=""><i class="icon-check"></i><span>Work Planner
								<span class="switchLoad-sub"></span></span>
								<span class="label label-lightred bubble switchWork switchPre"  id="tsk_count"></span></a>
							</li>
						
						<li>
								<a href="/ceo_apps_it/tvlhome/" class=""><i class="icon-plane"></i><span>Biz Tour
								<span class="switchLoad-sub"></span></span>
								<span class="label label-lightred bubble switchTour switchPre"  id="tour_count"></span>
								</a>
							</li>
							<li>
								<a href="/ceo_apps_it/bdhome/?type=N" class=""><i class="icon-lightbulb"></i><span>BD
