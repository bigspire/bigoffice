<?php
/* Smarty version 3.1.29, created on 2017-11-16 18:00:46
  from "C:\xampp\htdocs\bigoffice\app\webroot\it\templates\login_type.tpl" */

if ($_smarty_tpl->smarty->ext->_validateCompiled->decodeProperties($_smarty_tpl, array (
  'has_nocache_code' => false,
  'version' => '3.1.29',
  'unifunc' => 'content_5a0d84f6dd8ea2_46671261',
  'file_dependency' => 
  array (
    'e8239a8ef3721675e73dd7995af582e52aae726f' => 
    array (
      0 => 'C:\\xampp\\htdocs\\bigoffice\\app\\webroot\\it\\templates\\login_type.tpl',
      1 => 1472120826,
      2 => 'file',
    ),
  ),
...
function content_5a0d84f6dd8ea2_46671261 ($_smarty_tpl) {
...
" class="input-large" id="keyword" autocomplete="off" placeholder="Search here..." type="text"/> 
             ...
             <a href="login_type.php"><button style="margin-bottom:9px;margin-left:4px;" type="button" class="btn btn-primary"><i class="icon-refresh"></i> Reset</button></a>
             <a href="add_login_type.php"><button type="button" class="btn btn-primary" style="float:right"><i class="icon-plus"></i> Add Login Type</button></a>
             <a href="login_type.php?action=export&keyword=<?php echo $_POST['keyword'];?>
&l_status=<?php echo $_POST['l_status'];?>
