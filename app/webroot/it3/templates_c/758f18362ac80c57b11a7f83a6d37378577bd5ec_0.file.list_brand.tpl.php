<?php
/* Smarty version 3.1.29, created on 2016-08-25 16:00:08
  from "/var/www/html/itasset/templates/list_brand.tpl" */

if ($_smarty_tpl->smarty->ext->_validateCompiled->decodeProperties($_smarty_tpl, array (
  'has_nocache_code' => false,
  'version' => '3.1.29',
  'unifunc' => 'content_57bec8b039e0d3_97093068',
  'file_dependency' => 
  array (
    '758f18362ac80c57b11a7f83a6d37378577bd5ec' => 
    array (
      0 => '/var/www/html/itasset/templates/list_brand.tpl',
      1 => 1472120882,
      2 => 'file',
    ),
  ),
...
function content_57bec8b039e0d3_97093068 ($_smarty_tpl) {
...
" class="input-large" id="keyword" autocomplete="off" placeholder="Search here..." type="text"/> 
             ...
             <a href="list_brand.php"><button style="margin-bottom:9px;margin-left:4px;" type="button" class="btn btn-primary"><i class="icon-refresh"></i> Reset</button></a>
             <a href="add_brand.php"><button type="button" class="btn btn-primary" style="float:right"><i class="icon-plus"></i> Add Brand</button></a>
             <a href="list_brand.php?action=export&keyword=<?php echo $_POST['keyword'];?>
&b_type=<?php echo $_POST['b_type'];?>
&b_status=<?php echo $_POST['b_status'];?>
