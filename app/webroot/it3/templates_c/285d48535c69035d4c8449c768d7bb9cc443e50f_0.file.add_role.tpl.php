<?php
/* Smarty version 3.1.29, created on 2016-08-17 15:05:49
  from "/var/www/html/itasset/templates/add_role.tpl" */

if ($_smarty_tpl->smarty->ext->_validateCompiled->decodeProperties($_smarty_tpl, array (
  'has_nocache_code' => false,
  'version' => '3.1.29',
  'unifunc' => 'content_57b42ff5cb8d10_17722182',
  'file_dependency' => 
  array (
    '285d48535c69035d4c8449c768d7bb9cc443e50f' => 
    array (
      0 => '/var/www/html/itasset/templates/add_role.tpl',
      1 => 1470122611,
      2 => 'file',
    ),
  ),
...
function content_57b42ff5cb8d10_17722182 ($_smarty_tpl) {
	...
	<div class="container-fluid" id="content">
		<div id="main">
			<div class="container-fluid">
				...
				<form action=" " id="formID" class="form-horizontal form-column form-bordered" method="post" accept-charset="utf-8"><div style="display:none;"><input type="hidden" name="_method" value="POST"/></div>								
				<div class="span6">
...
"/> 
				...
				<div class="control-group">
						<label  for="textfield" class="control-label"> Permissions <span class="red_star"> *</span> </label>
							<div class="controls field" >					
<?php echo smarty_function_html_options(array('name'=>"permission[]",'multiple'=>"multiple",'size'=>"10",'separator'=>"  ",'class'=>"multi_select",'id'=>"RolePermission[]",'placeholder'=>'','style'=>"clear:left",'options'=>$_smarty_tpl->tpl_vars['permissions']->value,'selected'=>$_smarty_tpl->tpl_vars['permission_ar']->value),$_smarty_tpl);?>
				
<div class="errorMsg error"><?php echo $_smarty_tpl->tpl_vars['permissionErr']->value;?>
 </div>
</div>
				</div>
				<div class="control-group">
