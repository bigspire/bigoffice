<?php
/* Smarty version 3.1.29, created on 2016-08-23 16:17:25
  from "/var/www/html/itasset/templates/edit_software_confirmation.tpl" */

if ($_smarty_tpl->smarty->ext->_validateCompiled->decodeProperties($_smarty_tpl, array (
  'has_nocache_code' => false,
  'version' => '3.1.29',
  'unifunc' => 'content_57bc29bdf08615_74340818',
  'file_dependency' => 
  array (
    '95bf715e8d4333e2cd33d20f896317d09219f43d' => 
    array (
      0 => '/var/www/html/itasset/templates/edit_software_confirmation.tpl',
      1 => 1470810444,
      2 => 'file',
    ),
  ),
...
function content_57bc29bdf08615_74340818 ($_smarty_tpl) {
?>
			...
			<div class="container-fluid">
				...
				<div class="breadcrumbs">
					<ul>
						...
						<li>
							<a href="add_software_confirmation.php">Software</a>
								<i class="icon-angle-right"></i>
						</li>
	                           ...
	                           <div class="control-group">
	                               ...
	                               <div class="control-group">
									...
									<div class="control-group">
											...
											<div class="controls">
											<?php if (($_SESSION['s']['validitydate'] == '')) {?>
												<?php echo $_SESSION['s']['validityyear'];?>

											<?php } else { ?>
											<?php echo $_SESSION['s']['validityyear'];?>
 ( <?php echo $_SESSION['s']['validitydate'];?>
 )
											<?php }?>	
											</div>
										</div>
 ...
 <?php echo $_SESSION['s']['currencytype'];?>
                         ...
                         <div class="control-group">
		                         <label for="password" class="control-label">Attach Warranty </label>
									    <div class="controls">
 											<?php if (!empty($_SESSION['s']['warfile_edit'])) {?>
									    	<a href = "edit_software_confirmation.php?id=<?php echo $_GET['id'];?>
&action=download&file=<?php echo $_SESSION['s']['warfile_edit'];?>
"><?php echo $_SESSION['s']['warfile_edit'];?>
</a> 
										<?php } else { ?>									    
									    	<a href = "edit_software_confirmation.php?id=<?php echo $_GET['id'];?>
&action=download&file=<?php echo $_SESSION['s']['warfile'];?>
"><?php echo $_SESSION['s']['warfile'];?>
</a> 
										<?php }?>	
										</div>
										</div>
...
"><input type="button" class="btn" name="previous" id="submit_previous" value="Previous"></a>
