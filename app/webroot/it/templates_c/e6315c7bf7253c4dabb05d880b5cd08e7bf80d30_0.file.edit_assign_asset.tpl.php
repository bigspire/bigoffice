...
function content_591992d3884a12_37398626 ($_smarty_tpl) {
			...
			<span class="red_star"> *</span></label>
				<div class="controls">
					<select placeholder="" style="clear:left"  name="inventory_it_id_#index#" class="input-xlarge checkUnique" id="inventory_it_id_#index#">
						<option value="">Select</option>
							<?php echo smarty_function_html_options(array('options'=>$_smarty_tpl->tpl_vars['h_inventory']->value,'selected'=>$_smarty_tpl->tpl_vars['inventory_it_id']->value),$_smarty_tpl);?>
...
">
		<input type="hidden" id="it_hw_brand_idData_<?php echo $_smarty_tpl->tpl_vars['i']->value;?>
