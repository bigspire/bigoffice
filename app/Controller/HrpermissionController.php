...
class HrpermissionController extends AppController {  
	...
	public function index(){	
		// set the page title
		$this->set('title_for_layout', 'Permission - HRIS - BigOffice');	
	...
	public function create_permission(){ 
		// set the page title		
		$this->set('title_for_layout', 'Request Permission - HRIS - BigOffice');	
						...
						if($this->HrPerStatus->save($data, true, $fieldList = array('hr_permission_id','created_date','app_users_id'))){						
							...
							foreach($approval_data as $hr_data){
								if($superior_data['Home']['id'] != $hr_data['Home']['id']  && $hr_data['Home']['id'] != $this->Session->read('USER.Login.id')){
									...
									// notify superiors						
									if(!$this->send_email('BigOffice - '.ucfirst($this->Session->read('USER.Login.first_name')).' '.ucfirst($this->Session->read('USER.Login.last_name')).' created permission request (No Action Required)!', 'permission_creation', 'noreply@mypdca.in', $hr_data['Home']['email_address'],$vars)){	
										// show the msg.								
	...
	public function view_permission($id){
		// set the page title		
		$this->set('title_for_layout', 'View Permission - HRIS - BigOffice');
