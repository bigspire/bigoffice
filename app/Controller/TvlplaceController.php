...
class TvlplaceController extends AppController {  
	...
	public function index(){	
		// set the page title
		$this->set('title_for_layout', 'Place - Biz Tour - BigOffice');
	...
	public function create_place(){ 
		// set the page title		
		$this->set('title_for_layout', 'Create Place - Biz Tour - BigOffice');				
		if ($this->request->is('post')){ 
			// validates the form
	...
	public function edit_place($id){	
		// set the page title		
		$this->set('title_for_layout', 'Edit Place - Biz Tour - BigOffice');			
		if (!empty($id) && intval($id)){
			// authorize user before action
			$ret_value = $this->auth_action($id);
			if($ret_value == 'pass'){	
	...
	public function view_place($id){
		// set the page title		
		$this->set('title_for_layout', 'View Place - Biz Tour - BigOffice');
		if(!empty($id) && intval($id)){
			// authorize user before action
			$ret_value = $this->auth_action($id);
			if($ret_value == 'pass'){	
