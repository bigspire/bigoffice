...
class HrorgController extends AppController {  
	...
	public function index(){	
		// set the page title
		$this->set('title_for_layout', 'Organization Updates - HRIS - BigOffice');
	...
	public function create_updates(){ 
		// set the page title		
		$this->set('title_for_layout', 'Create Organization Updates - HRIS - BigOffice');	
	...
	public function edit_updates($id){	
		// set the page title		
		$this->set('title_for_layout', 'Edit Organization Updates - HRIS - BigOffice');			
	...
	public function view_updates($id){
		// set the page title		
		$this->set('title_for_layout', 'View Organization Updates - HRIS - BigOffice');
		if(!empty($id) && intval($id)){
			// authorize user before action
			$ret_value = $this->auth_action($id);
			if($ret_value == 'pass'){	
