...
class HrbankController extends AppController {  
	...
	public function index(){	
		// set the page title
		$this->set('title_for_layout', 'Bank - HRIS - BigOffice');
	...
	public function create_bank(){ 
		// set the page title		
		$this->set('title_for_layout', 'Create Bank - HRIS - BigOffice');				
		if ($this->request->is('post')){ 
			// validates the form
	...
	public function edit_bank($id){	
		// set the page title		
		$this->set('title_for_layout', 'Edit Bank - HRIS - BigOffice');			
	...
	public function view_bank($id){
		// set the page title		
		$this->set('title_for_layout', 'View Bank - HRIS - BigOffice');
		if(!empty($id) && intval($id)){
			// authorize user before action
			$ret_value = $this->auth_action($id);
			if($ret_value == 'pass'){	
