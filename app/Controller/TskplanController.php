...
class TskplanController extends AppController {  
	...
	public function index(){ 
		// set the page title
		$this->set('title_for_layout', 'My Tasks - Work Planner - BigOffice');
	...
	public function edit_task($id){	
		// set the page title		
		$this->set('title_for_layout', 'Edit Task Plan - Work Planner - BigOffice');
		// load task types
		$this->set('taskType', array('D' => 'Daily Plan', 'P' => 'Project Plan'));
		$this->set('planType', $this->load_plan_types());		
		if (!empty($id) && intval($id)){
	...
	public function view_task($id){
		$this->layout = 'tsk_iframe';
		// set the page title		
		$this->set('title_for_layout', 'View My Tasks - Work Planner - BigOffice');
		if(!empty($id) && intval($id)){
			// authorize user before action
			$ret_value = $this->auth_action($id);
			if($ret_value == 'pass'){	
