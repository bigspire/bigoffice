...
class HrformController extends AppController {  
	...
	public function index(){	
		// set the page title
		$this->set('title_for_layout', 'Form - HRIS - BigOffice');
	...
	public function create_form(){ 
		// set the page title		
		$this->set('title_for_layout', 'Create Form - HRIS - BigOffice');	
		$this->load_category();	
		if ($this->request->is('post')){ 
			// validates the form
	...
	public function edit_form($id){	
		// set the page title		
		$this->set('title_for_layout', 'Edit Form - HRIS - BigOffice');			
	...
	public function view_form($id){
		// set the page title		
		$this->set('title_for_layout', 'View Form - HRIS - BigOffice');
		if(!empty($id) && intval($id)){
			// authorize user before action
			$ret_value = $this->auth_action($id);
			if($ret_value == 'pass'){	
