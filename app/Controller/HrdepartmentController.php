...
class HrDepartmentController extends AppController {  
	...
	public function index(){	
		// set the page title
		$this->set('title_for_layout', 'Department - HRIS - BigOffice');
	...
	public function create_dept(){ 
		// set the page title		
		$this->set('title_for_layout', 'Create Department - HRIS - BigOffice');				
		if ($this->request->is('post')){ 
			// validates the form
	...
	public function edit_dept($id){	
		// set the page title		
		$this->set('title_for_layout', 'Edit Department - HRIS - BigOffice');			
	...
	public function view_dept($id){
		// set the page title		
		$this->set('title_for_layout', 'View Department - HRIS - BigOffice');
		if(!empty($id) && intval($id)){
			// authorize user before action
			$ret_value = $this->auth_action($id);
			if($ret_value == 'pass'){	
