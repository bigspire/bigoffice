...
class TskprojectcontactsController extends AppController {  
	...
	public function index(){	
		// set the page title
		$this->set('title_for_layout', 'Project Contact Contacts - Finance - BigOffice');
	...
	public function create_project_contact(){ 
		// set the page title		
		$this->set('title_for_layout', 'Create Project Contact Contact - Finance - BigOffice');			
		// fetch the projects
	...
	public function edit_project_contact($id){	
		// set the page title		
		$this->set('title_for_layout', 'Edit Project Contact - Finance - BigOffice');				
		// fetch the projects
		$proj_list = $this->TskProjectContact->TskProject->find('list', array('fields' => array('id','project_name'), 'order' => array('project_name ASC'),'conditions' => array('is_deleted' => 'N')));
		$this->set('projList', $proj_list);
	...
	public function view_customer($id){
		// set the page title		
		$this->set('title_for_layout', 'View Customer - Finance - BigOffice');
		if(!empty($id) && intval($id)){
			// authorize user before action
			$ret_value = $this->auth_action($id);
			if($ret_value == 'pass'){	
