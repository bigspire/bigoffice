...
class HrattchangeController extends AppController {  
	...
	public function index(){	
		// set the page title
		$this->set('title_for_layout', 'Attendance Change - HRIS - BigOffice');		
	...
	public function change_attendance(){ 
		// set the page title		
		$this->set('title_for_layout', 'Request Attendance Change - HRIS - BigOffice');	
	...
	public function view_change($id){
		// set the page title		
		$this->set('title_for_layout', 'View Attendance Change - HRIS - BigOffice');
