...
class TskFileController extends AppController {  
	...
	public function index(){	
		// set the page title
		$this->set('title_for_layout', 'My Files - Work Planner - BigOffice');
	...
	*/
	...
	public function create_file(){ 
		// set the page title		
		$this->set('title_for_layout', 'Create File - Work Planner - BigOffice');	
		// load send to users
		$this->load_employee();
		// load team members
		//$this->load_team();
	...
	public function edit_file($id){	
		// set the page title		
		$this->set('title_for_layout', 'Edit File - Work Planner - BigOffice');		
		if($this->Session->read('rand_id') == ''){
			$this->Session->write('rand_id', rand(0, 100000));
		}
		// load send to users
	...
	public function view_file($id){
		// set the page title		
		$this->set('title_for_layout', 'View File - Work Planner - BigOffice');
		if(!empty($id) && intval($id)){
			// authorize user before action
			$ret_value = $this->auth_action($id);
			if($ret_value == 'pass'){	
