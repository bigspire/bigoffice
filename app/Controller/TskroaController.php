...
class TskroaController extends AppController {  
	...
	public function index(){	
		// set the page title
		$this->set('title_for_layout', 'ROA - Work Planner - BigOffice');
	...
	public function recommend(){ 
		// set the page title		
		$this->set('title_for_layout', 'Recommend ROA - Work Planner - BigOffice');
		// get team members
	...
	public function notify_employee($data){		
		...
		foreach($data as $key => $value){
			...
			// notify employee						
			if(!$this->send_email('BigOffice - Congrats! You have been selected for Round of Applause this month', 'notify_applause_star', 'noreply@mypdca.in', $user_detail['HrEmployee']['email_address'], $vars)){		
				// show the msg.								
