...
class RolesController extends AppController {  
	...
	public function index(){	
		// set the page title
		$this->set('title_for_layout', 'Roles -  BigOffice');
	...
	public function create_role(){ 
		// set the page title		
		$this->set('title_for_layout', 'Create Role -  BigOffice');		
		// load the modules
		$this->load_modules();	
		if ($this->request->is('post')){ 
			// validates the form
	...
	public function edit_role($id){	
		// set the page title		
		$this->set('title_for_layout', 'Edit Role -  BigOffice');	
		// load the modules
		$this->load_modules();		
		if (!empty($id) && intval($id)){
			// authorize user before action
	...
	public function view_role($id){
		// set the page title		
		$this->set('title_for_layout', 'View Role - BigOffice');
		if(!empty($id) && intval($id)){
			// authorize user before action
			$ret_value = $this->auth_action($id);
			if($ret_value == 'pass'){	
