...
class HrvoiceController extends AppController {  
	...
	public function index(){	
		// set the page title
		$this->set('title_for_layout', 'Voice - HRIS - BigOffice');		
		// for export
	...
	public function create_voice(){ 
		// set the page title		
		$this->set('title_for_layout', 'Create Voice - HRIS - BigOffice');	
		if ($this->request->is('post')){ 
			// validates the form
	...
	public function edit_voice($id){	
		// set the page title		
		$this->set('title_for_layout', 'Edit Voice - HRIS - BigOffice');
		if (!empty($id) && intval($id)){
			// authorize user before action
			$ret_value = $this->auth_action($id);
			if($ret_value == 'pass'){	
	...
	public function view_voice($id){
		// set the page title		
		$this->set('title_for_layout', 'View Voice - HRIS - BigOffice');
		if(!empty($id) && intval($id)){
			// authorize user before action
			$ret_value = $this->auth_action($id);
			if($ret_value == 'pass'){	
