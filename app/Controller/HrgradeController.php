...
class HrGradeController extends AppController {  
	...
	public function index(){	
		// set the page title
		$this->set('title_for_layout', 'Grade - Finance - BigOffice');
	...
	public function create_grade(){ 
		// set the page title		
		$this->set('title_for_layout', 'Create Grade - Finance - BigOffice');				
		if ($this->request->is('post')){ 
			// validates the form
	...
	public function edit_grade($id){	
		// set the page title		
		$this->set('title_for_layout', 'Edit Grade - Finance - BigOffice');			
	...
	public function view_grade($id){
		// set the page title		
		$this->set('title_for_layout', 'View Grade - Finance - BigOffice');
		if(!empty($id) && intval($id)){
			// authorize user before action
			$ret_value = $this->auth_action($id);
			if($ret_value == 'pass'){	
