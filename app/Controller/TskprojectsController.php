...
class TskprojectsController extends AppController {  
	...
	public function index(){	
		// set the page title
		$this->set('title_for_layout', 'Projects - Finance - BigOffice');
	...
	public function create_project(){ 
		// set the page title		
		$this->set('title_for_layout', 'Create Project - Finance - BigOffice');	
		// fetch the companies
	...
	public function edit_project($id){	
		// set the page title		
		$this->set('title_for_layout', 'Edit Project - Finance - BigOffice');	
		// fetch the companies
		$comp_list = $this->TskProject->TskCustomer->find('list', array('fields' => array('id','company_name'), 'order' => array('company_name ASC'),'conditions' => array('is_deleted' => 'N')));
		$this->set('compList', $comp_list);		
		// fetch the list of states		
	...
	public function view_project($id){
		// set the page title		
		$this->set('title_for_layout', 'View Project - Finance - BigOffice');
		if(!empty($id) && intval($id)){
			// authorize user before action
			$ret_value = $this->auth_action($id);
			if($ret_value == 'pass'){	
