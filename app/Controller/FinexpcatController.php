...
class FinExpCatController extends AppController {  
	...
	public function index(){	
		// set the page title
		$this->set('title_for_layout', 'Expense Category - Finance - BigOffice');
	...
	public function create_category(){ 
		// set the page title		
		$this->set('title_for_layout', 'Create Expense Category - Finance - BigOffice');				
		if ($this->request->is('post')){ 
			// validates the form
	...
	public function edit_category($id){	
		// set the page title		
		$this->set('title_for_layout', 'Edit Expense Category - Finance - BigOffice');			
		if (!empty($id) && intval($id)){
			// authorize user before action
			$ret_value = $this->auth_action($id);
			if($ret_value == 'pass'){	
	...
	public function view_category($id){
		// set the page title		
		$this->set('title_for_layout', 'View Expense Category - Finance - BigOffice');
		if(!empty($id) && intval($id)){
			// authorize user before action
			$ret_value = $this->auth_action($id);
			if($ret_value == 'pass'){	
