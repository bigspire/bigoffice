...
class TskcustomersController extends AppController {  
	...
	public function index(){	
		// set the page title
		$this->set('title_for_layout', 'Customers - Finance - BigOffice');
	...
	public function create_customer(){ 
		// set the page title		
		$this->set('title_for_layout', 'Create Customer - Finance - BigOffice');	
	...
	public function edit_customer($id){	
		// set the page title		
		$this->set('title_for_layout', 'Edit Customer - Finance - BigOffice');				
		// fetch the list of states
		$this->loadModel('State');
		$state_list = $this->State->find('list', array('fields' => array('id','state_name'), 'order' => array('state_name ASC'),'conditions' => array('State.status' => 1)));
		$this->set('stateList', $state_list);
