...
class HrholidayController extends AppController {  
	...
	public function index(){	
		// set the page title
		$this->set('title_for_layout', 'Holidays - HRIS - BigOffice');
		$this->load_branch();
	...
	public function create_holiday(){ 
		// set the page title		
		$this->set('title_for_layout', 'Create Holidays - HRIS - BigOffice');	
		$this->load_branch();
		if ($this->request->is('post')){ 
			// validates the form
	...
	public function edit_holiday($id){	
		// set the page title		
		$this->set('title_for_layout', 'Edit Holiday - HRIS - BigOffice');	
		$this->load_branch();	
	...
	public function view_holiday($id){
		// set the page title		
		$this->set('title_for_layout', 'View Holidays - HRIS - BigOffice');
		if(!empty($id) && intval($id)){
			// authorize user before action
			$ret_value = $this->auth_action($id);
			if($ret_value == 'pass'){	
