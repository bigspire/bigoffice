...
class HrleavedetailsController extends AppController {  
	...
	public function index(){	
		// set the page title
		$this->set('title_for_layout', 'Employee  Leave Details - HRIS - BigOffice');
	...
	public function edit_leave_details($id,$timing_id){
		$this->layout = 'iframe';
		// set the page title		
		$this->set('title_for_layout', 'Edit Employee  Leave Details - HRIS - BigOffice');		
	...
	public function upload(){		
		// set the page title		
		$this->set('title_for_layout', 'Upload PL - HRIS - BigOffice');		
		// when the form submitted
		if (!empty($this->request->data)){ 
			// validates the form
			$this->HrLeaveDetail->set($this->request->data);				
