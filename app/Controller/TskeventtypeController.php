...
class TskeventtypeController extends AppController {  
	...
	public function index(){	
		// set the page title
		$this->set('title_for_layout', 'Event Types - Work Planner - BigOffice');
	...
	public function create_event_type(){ 
		// set the page title		
		$this->set('title_for_layout', 'Create Event Type - Work Planner - BigOffice');	
	...
	public function edit_event_type($id){	
		// set the page title		
		$this->set('title_for_layout', 'Edit Event Type - Work Planner - BigOffice');	
		$this->set_event_color();
		if (!empty($id) && intval($id)){
			// authorize user before action
			$ret_value = $this->auth_action($id);
	...
	public function view_event_type($id){
		// set the page title		
		$this->set('title_for_layout', 'View Event Type - Work Planner - BigOffice');
		if(!empty($id) && intval($id)){
			// authorize user before action
			$ret_value = $this->auth_action($id);
			if($ret_value == 'pass'){	
