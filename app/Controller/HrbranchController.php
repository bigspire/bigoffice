...
class HrbranchController extends AppController {  
	...
	public function index(){	
		// set the page title
		$this->set('title_for_layout', 'Branch - HRIS - BigOffice');
	...
	public function create_branch(){ 
		// set the page title		
		$this->set('title_for_layout', 'Create Branch - HRIS - BigOffice');				
		if ($this->request->is('post')){ 
			// validates the form
	...
	public function edit_branch($id){	
		// set the page title		
		$this->set('title_for_layout', 'Edit Branch - HRIS - BigOffice');			
	...
	public function view_branch($id){
		// set the page title		
		$this->set('title_for_layout', 'View Branch - HRIS - BigOffice');
		if(!empty($id) && intval($id)){
			// authorize user before action
			$ret_value = $this->auth_action($id);
			if($ret_value == 'pass'){	
