...
class FinexplimitController extends AppController {  
	...
	public function index(){	
		// set the page title
		$this->set('title_for_layout', 'Expense Limit - Finance - BigOffice');
	...
	public function create_explimit(){ 
		// set the page title		
		$this->set('title_for_layout', 'Create Expense Limit - Finance - BigOffice');
		// load the modules
	...
	public function edit_explimit($id){	
		// set the page title		
		$this->set('title_for_layout', 'Edit Expense Limit - Finance - BigOffice');		
		// load the modules
		$this->load_grade_modules();	
	...
	public function view_explimit($id){
		// set the page title		
		$this->set('title_for_layout', 'View Expense Limit - Finance - BigOffice');
		if(!empty($id) && intval($id)){
			// authorize user before action
			$ret_value = $this->auth_action($id);
			if($ret_value == 'pass'){	
