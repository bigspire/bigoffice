...
class HrbusinessunitController extends AppController {  
	...
	public function index(){	
		// set the page title
		$this->set('title_for_layout', 'Business Unit - HRIS - BigOffice');
	...
	public function create_business_unit(){ 
		// set the page title		
		$this->set('title_for_layout', 'Create Business Unit - HRIS - BigOffice');				
		if ($this->request->is('post')){ 
			// validates the form
	...
	public function edit_business_unit($id){	
		// set the page title		
		$this->set('title_for_layout', 'Edit Business Unit - HRIS - BigOffice');			
	...
	public function view_business_unit($id){
		// set the page title		
		$this->set('title_for_layout', 'View Business Unit - HRIS - BigOffice');
		if(!empty($id) && intval($id)){
			// authorize user before action
			$ret_value = $this->auth_action($id);
			if($ret_value == 'pass'){	
