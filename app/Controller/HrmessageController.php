...
class HrmessageController extends AppController {  
	...
	public function index(){	
		// set the page title
		$this->set('title_for_layout', 'Message - HRIS - BigOffice');
	...
	public function create_message(){ 
		// set the page title		
		$this->set('title_for_layout', 'Create Message - HRIS - BigOffice');	
	...
	public function view_message($id){
		// set the page title		
		$this->set('title_for_layout', 'View Message - HRIS - BigOffice');
		if(!empty($id) && intval($id)){
			// authorize user before action
			$ret_value = $this->auth_action($id);
			if($ret_value == 'pass'){	
