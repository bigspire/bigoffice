...
class BdbusinessController extends AppController {  
	...
	public function index(){	
		...
		$this->set('title_for_layout', $page_title.'My Business - BD - BigOffice');		
	...
	public function add(){	
		// check bd spoc
			$this->set('title_for_layout', 'Add Business - My Business - BD - BigOffice');
			// load static drop downs
			$this->load_static_dropdown();
			if ($this->request->is('post')){
				// validates the form
	...
	public function send_mail_user($data, $approve){
		...
		$sub = 'BigOffice - New Business '.$status.' By '.ucfirst($this->Session->read('USER.Login.first_name')).' '.ucfirst($this->Session->read('USER.Login.last_name'));
	...
	public function edit($id){	
		// set the page title		
		$this->set('title_for_layout', 'Edit Business - BD - BigOffice');
	...
	public function view($id){	
		// set the page title
		$this->layout = 'iframe';
		$this->set('title_for_layout', 'View Business - My Business - BD - BigOffice');
		if (!empty($id) && intval($id)){
			// authorize user before action
