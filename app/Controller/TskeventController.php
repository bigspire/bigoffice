...
class TskeventController extends AppController {  
	...
	public function index(){	
		// set the page title
		$this->set('title_for_layout', 'My Events - Work Planner - BigOffice');
		$this->retain_menu();
		// get user theme
	...
	public function list_event(){	
		// set the page title
		$this->set('title_for_layout', 'List Events - Work Planner - BigOffice');
		$this->retain_menu();
		// fetch list of types
	...
	public function create_event(){ 
		// set the page title		
		$this->set('title_for_layout', 'Create Event - Work Planner - BigOffice');	
		$this->retain_menu();		
		// load event types
		$this->set_event_types();
		// load event status
	...
	public function edit_event($id){	
		// set the page title		
		$this->set('title_for_layout', 'Edit Event - Work Planner - BigOffice');
		$this->retain_menu();	
		// load event types
		$this->set_event_types();
		// load event status
	...
	public function view_event($id){
		// set the page title		
		$this->set('title_for_layout', 'View Event - Work Planner - BigOffice');
		$this->retain_menu();	
		if(!empty($id) && intval($id)){
			// authorize user before action
			$ret_value = $this->auth_action($id);
