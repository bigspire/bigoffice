...
class HrsurveyController extends AppController {  
	...
	public function index(){	
		// set the page title
		$this->set('title_for_layout', 'Survey - HRIS - BigOffice');		
		// for export
	...
	public function create_survey(){ 
		// set the page title		
		$this->set('title_for_layout', 'Create Survey - HRIS - BigOffice');	
		if ($this->request->is('post')){ 
			// validates the form
	...
	public function edit_survey($id){	
		// set the page title		
		$this->set('title_for_layout', 'Edit Survey - HRIS - BigOffice');
		if (!empty($id) && intval($id)){
			// authorize user before action
			$ret_value = $this->auth_action($id);
			if($ret_value == 'pass'){	
	...
	public function view_survey($id){
		// set the page title		
		$this->set('title_for_layout', 'View Survey - HRIS - BigOffice');
