...
class TskteamassignController extends AppController {  
	...
	public function index(){	
		// set the page title
		$this->set('title_for_layout', 'Assigned by Me - Work Planner - BigOffice');
	...
	public function edit_task($id){	
		// set the page title		
		$this->set('title_for_layout', 'Edit Task - Work Planner - BigOffice');		
	...
	public function view_task($id){
		...
		// set the page title		
		$this->set('title_for_layout', 'View Task - Work Planner - BigOffice');
		if(!empty($id) && intval($id)){
			// authorize user before action
			$ret_value = $this->auth_action($id);
			if($ret_value == 'pass'){	
