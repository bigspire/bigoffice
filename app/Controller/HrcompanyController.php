...
class HrcompanyController extends AppController {  
	...
	public function index(){	
		// set the page title
		$this->set('title_for_layout', 'Company - HRIS - BigOffice');		
		// fetch the advances		
	...
	public function edit_company($id){	
		// set the page title		
		$this->set('title_for_layout', 'Edit Customer - HRIS - BigOffice');				
	...
	public function view_company($id){
		// set the page title		
		$this->set('title_for_layout', 'View Company - HRIS - BigOffice');
		if(!empty($id) && intval($id)){			
