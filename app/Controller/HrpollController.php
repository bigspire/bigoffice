...
class HrpollController extends AppController {  
	...
	public function index(){	
		// set the page title
		$this->set('title_for_layout', 'Poll - HRIS - BigOffice');
	...
	public function create_poll(){ 
		// set the page title		
		$this->set('title_for_layout', 'Create Poll - HRIS - BigOffice');	
	...
	public function edit_poll($id){	
		// set the page title		
		$this->set('title_for_layout', 'Edit Poll - HRIS - BigOffice');
		$this->set('correctAns', array('1' => 'Option 1', '2' => 'Option 2','3' => 'Option 3','4' => 'Option 4','5' => 'Option 5','6' => 'Option 6','7' => 'None'));		
		if (!empty($id) && intval($id)){
			// authorize user before action
			$ret_value = $this->auth_action($id);
	...
	public function view_poll($id, $tot_votes){
		// set the page title		
		$this->set('title_for_layout', 'View Poll - HRIS - BigOffice');
